...
<div id="navigation" class="powen-nav clear">
	...
	<nav id="menu-icon" class="powen-top-most-nav">
		<a href="#site-navigation"><i class="mm"></i><?php echo esc_textarea( powen_mod( 'menu_one_title_textbox'), 'powen-lite' ); ?></a>
	</nav>
	<?php } ?>
	...
	<nav id="site-navigation" class="powen-main-navigation" role="navigation">
		...
		<a href="#main-nav"><i class="m"></i><?php echo esc_textarea( powen_mod( 'menu_two_title_textbox'), 'powen-lite' ); ?></a>
	</nav>
	<?php } ?>
