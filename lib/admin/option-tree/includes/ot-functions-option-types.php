 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_display_by_type' ) ) {

  function powen_display_by_type( $args = array() ) {
    
    /* allow filters to be executed on the array */
    $args = apply_filters( 'powen_display_by_type', $args );
    
    /* build the function name */
    $function_name_by_type = str_replace( '-', '_', 'powen_type_' . $args['type'] );
 ...
 *
 * See @powen_display_by_type to see the full list of available arguments.
 *
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_background' ) ) {
  
  function powen_type_background( $args = array() ) {
    ...
    echo '<div class="format-setting type-background ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">'; 
        ...
        $powen_recognized_background_fields = apply_filters( 'powen_recognized_background_fields', array( 
          'background-color',
          'background-repeat', 
        ...
        echo '<div class="ot-background-group">';
          ...
          if ( in_array( 'background-color', $powen_recognized_background_fields ) ) {
          
            echo '<div class="option-tree-ui-colorpicker-input-wrap">';
              
              /* colorpicker JS */      
              echo '<script>jQuery(document).ready(function($) { powen_UI.bind_colorpicker("' . esc_attr( $field_id ) . '-picker"); });</script>';
          ...
          if ( in_array( 'background-repeat', $powen_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-repeat]" id="' . esc_attr( $field_id ) . '-repeat" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              foreach ( powen_recognized_background_repeat( $field_id ) as $key => $value ) {
          ...
          if ( in_array( 'background-attachment', $powen_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-attachment]" id="' . esc_attr( $field_id ) . '-attachment" class="option-tree-ui-select ' . $field_class . '">';
              ...
              foreach ( powen_recognized_background_attachment( $field_id ) as $key => $value ) {
          ...
          if ( in_array( 'background-position', $powen_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-position]" id="' . esc_attr( $field_id ) . '-position" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              foreach ( powen_recognized_background_position( $field_id ) as $key => $value ) {
          ...
          if ( in_array( 'background-size', $powen_recognized_background_fields ) ) {
             ...
             *
             */
            $choices = apply_filters( 'powen_type_background_size_choices', '', $field_id );
        ...
        if ( in_array( 'background-image', $powen_recognized_background_fields ) ) {
          ...
          echo '<div class="option-tree-ui-upload-parent">';
            ...
            /* add media button */
            echo '<a href="javascript:void(0);" class="powen_upload_media option-tree-ui-button button button-primary light" rel="' . $post_id . '" title="' . __( 'Add Media', 'option-tree' ) . '"><span class="icon ot-icon-plus-circle"></span>' . __( 'Add Media', 'option-tree' ) . '</a>';
 ...
 * @since     2.5.0
 */
if ( ! function_exists( 'powen_type_border' ) ) {

  function powen_type_border( $args = array() ) {
    ...
    echo '<div class="format-setting type-border ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* allow fields to be filtered */
        $powen_recognized_border_fields = apply_filters( 'powen_recognized_border_fields', array(
          'width',
          'unit',
          'style',
          'color'
        ...
        /* build border width */
        if ( in_array( 'width', $powen_recognized_border_fields ) ) {
        ...
        /* build unit dropdown */
        if ( in_array( 'unit', $powen_recognized_border_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-fourth">';
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[unit]" id="' . esc_attr( $field_id ) . '-unit" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              foreach ( powen_recognized_border_unit_types( $field_id ) as $unit ) {
        ...
        if ( in_array( 'style', $powen_recognized_border_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-fourth">';
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[style]" id="' . esc_attr( $field_id ) . '-style" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              foreach ( powen_recognized_border_style_types( $field_id ) as $key => $style ) {
        ...
        /* build color */
        if ( in_array( 'color', $powen_recognized_border_fields ) ) {
 ...
 * @since     2.5.0
 */
if ( ! function_exists( 'powen_type_box_shadow' ) ) {

  function powen_type_box_shadow( $args = array() ) {
    ...
    echo '<div class="format-setting type-box-shadow ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* allow fields to be filtered */
        $powen_recognized_box_shadow_fields = apply_filters( 'powen_recognized_box_shadow_fields', array(
          'inset',
          'offset-x',
          'offset-y',
          'blur-radius',
        ...
        /* build inset */
        if ( in_array( 'inset', $powen_recognized_box_shadow_fields ) ) {
        ...
        if ( in_array( 'offset-x', $powen_recognized_box_shadow_fields ) ) {
        ...
        if ( in_array( 'offset-y', $powen_recognized_box_shadow_fields ) ) {
        ...
        if ( in_array( 'blur-radius', $powen_recognized_box_shadow_fields ) ) {
        ...
        if ( in_array( 'spread-radius', $powen_recognized_box_shadow_fields ) ) {
        ...
        /* build color */
        if ( in_array( 'color', $powen_recognized_box_shadow_fields ) ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_category_checkbox' ) ) {
  
  function powen_type_category_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-category-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* get category array */
        $categories = get_categories( apply_filters( 'powen_type_category_checkbox_query', array( 'hide_empty' => false ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_category_select' ) ) {
  
  function powen_type_category_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-category-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* get category array */
        $categories = get_categories( apply_filters( 'powen_type_category_select_query', array( 'hide_empty' => false ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_checkbox' ) ) {
  
  function powen_type_checkbox( $args = array() ) {
 ...
 * @updated   2.2.0
 */
if ( ! function_exists( 'powen_type_colorpicker' ) ) {
  
  function powen_type_colorpicker( $args = array() ) {
    ...
    echo '<div class="format-setting type-colorpicker ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">'; 
        ...
        echo '<div class="option-tree-ui-colorpicker-input-wrap">';
          ...
          /* colorpicker JS */      
          echo '<script>jQuery(document).ready(function($) { powen_UI.bind_colorpicker("' . esc_attr( $field_id ) . '"); });</script>';
 ...
 * @since     2.5.0
 */
if ( ! function_exists( 'powen_type_colorpicker_opacity' ) ) {

  function powen_type_colorpicker_opacity( $args = array() ) {

    $args['field_class'] = isset( $args['field_class'] ) ? $args['field_class'] . ' ot-colorpicker-opacity' : 'ot-colorpicker-opacity';
    powen_type_colorpicker( $args );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_css' ) ) {
  
  function powen_type_css( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_custom_post_type_checkbox' ) ) {
  
  function powen_type_custom_post_type_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-custom-post-type-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query posts array */
        $my_posts = get_posts( apply_filters( 'powen_type_custom_post_type_checkbox_query', array( 'post_type' => $post_type, 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_custom_post_type_select' ) ) {
  
  function powen_type_custom_post_type_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-custom-post-type-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query posts array */
        $my_posts = get_posts( apply_filters( 'powen_type_custom_post_type_select_query', array( 'post_type' => $post_type, 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
 ...
 * @since     2.3
 */
if ( ! function_exists( 'powen_type_date_picker' ) ) {
  
  function powen_type_date_picker( $args = array() ) {
    ...
    /* filter date format */
    $date_format = apply_filters( 'powen_type_date_picker_date_format', 'yy-mm-dd', $field_id );
     ...
     * @param string $field_id The field ID.
     */
    $is_readonly = apply_filters( 'powen_type_date_picker_readonly', false, $field_id );

    /* format setting outer wrapper */
    echo '<div class="format-setting type-date-picker ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
    
    /* date picker JS */      
    echo '<script>jQuery(document).ready(function($) { powen_UI.bind_date_picker("' . esc_attr( $field_id ) . '", "' . esc_attr( $date_format ) . '"); });</script>';      
 ...
 * @since     2.3
 */
if ( ! function_exists( 'powen_type_date_time_picker' ) ) {
  
  function powen_type_date_time_picker( $args = array() ) {
    ...
    /* filter date format */
    $date_format = apply_filters( 'powen_type_date_time_picker_date_format', 'yy-mm-dd', $field_id );
     ...
     * @param string $field_id The field ID.
     */
    $is_readonly = apply_filters( 'powen_type_date_time_picker_readonly', false, $field_id );

    /* format setting outer wrapper */
    echo '<div class="format-setting type-date-time-picker ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
    
    /* date time picker JS */      
    echo '<script>jQuery(document).ready(function($) { powen_UI.bind_date_time_picker("' . esc_attr( $field_id ) . '", "' . esc_attr( $date_format ) . '"); });</script>';      
 ...
 * @since     2.5.0
 */
if ( ! function_exists( 'powen_type_dimension' ) ) {

  function powen_type_dimension( $args = array() ) {
    ...
    echo '<div class="format-setting type-dimension ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* allow fields to be filtered */
        $powen_recognized_dimension_fields = apply_filters( 'powen_recognized_dimension_fields', array(
          'width',
          'height',
          'unit'
        ), $field_id );
        ...
        if ( in_array( 'width', $powen_recognized_dimension_fields ) ) {
        ...
        if ( in_array( 'height', $powen_recognized_dimension_fields ) ) {
        ...
        /* build unit dropdown */
        if ( in_array( 'unit', $powen_recognized_dimension_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-third ot-option-group--is-last">';
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[unit]" id="' . esc_attr( $field_id ) . '-unit" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              foreach ( powen_recognized_dimension_unit_types( $field_id ) as $unit ) {
                echo '<option value="' . esc_attr( $unit ) . '"' . ( isset( $field_value['unit'] ) ? selected( $field_value['unit'], $unit, false ) : '' ) . '>' . esc_attr( $unit ) . '</option>';
              }
 ...
 * @since     2.2.0
 */
if ( ! function_exists( 'powen_type_gallery' ) ) {

  function powen_type_gallery( $args = array() ) {
 ...
 * @since     2.5.0
 */
if ( ! function_exists( 'powen_type_google_fonts' ) ) {
  
  function powen_type_google_fonts( $args = array() ) {
    ...
    echo '<div class="format-setting type-google-font ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">'; 
        ...
        /* allow fields to be filtered */
        $powen_recognized_google_fonts_fields = apply_filters( 'powen_recognized_google_font_fields', array(
          'variants', 
          'subsets'
        ), $field_id );
          ...
          echo '<div class="type-google-font-group">';
            ...
            echo '<div class="option-tree-google-font-family">';
              ...
              echo '<select name="' . esc_attr( $field_name ) . '[' . $key . '][family]" id="' . esc_attr( $field_id ) . '-' . $key . '" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
                echo '<option value="">' . __( '-- Choose One --', 'option-tree' ) . '</option>';
                foreach ( powen_recognized_google_font_families( $field_id ) as $family_key => $family_value ) {
            ...
            /* build font variants */
            if ( in_array( 'variants', $powen_recognized_google_fonts_fields ) ) {
              ...
              foreach ( powen_recognized_google_font_variants( $field_id, $family ) as $variant_key => $variant ) {
            ...
            /* build font subsets */
            if ( in_array( 'subsets', $powen_recognized_google_fonts_fields ) ) {
              ...
              foreach ( powen_recognized_google_font_subsets( $field_id, $family ) as $subset_key => $subset ) {
                echo '<p class="checkbox-wrap">';
 ...
 * @since     2.5.0
 */
if ( ! function_exists( 'powen_type_javascript' ) ) {
  
  function powen_type_javascript( $args = array() ) {
 ...
 * @since     2.5.0
 */
if ( ! function_exists( 'powen_type_link_color' ) ) {

  function powen_type_link_color( $args = array() ) {
    ...
    echo '<div class="format-setting type-link-color ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* allow fields to be filtered */
        $powen_recognized_link_color_fields = apply_filters( 'powen_recognized_link_color_fields', array(
        ...
        foreach( $powen_recognized_link_color_fields as $type => $label ) {

          if ( array_key_exists( $type, $powen_recognized_link_color_fields ) ) {
            ...
            echo '<div class="option-tree-ui-colorpicker-input-wrap">';
              ...
              /* colorpicker JS */
              echo '<script>jQuery(document).ready(function($) { powen_UI.bind_colorpicker("' . esc_attr( $field_id ) . '-picker-' . $type . '"); });</script>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_list_item' ) ) {
  
  function powen_type_list_item( $args = array() ) {
    ...
    echo '<div class="format-setting type-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        echo '<input type="hidden" name="' . esc_attr( $field_id ) . '_settings_array" id="' . esc_attr( $field_id ) . '_settings_array" value="' . powen_encode( serialize( $field_settings ) ) . '" />';
        ...
        if ( is_array( $field_value ) && ! empty( $field_value ) ) {
          ...
          foreach( $field_value as $key => $list_item ) {
            ...
            echo '<li class="ui-state-default list-list-item">';
              powen_list_item_view( $field_id, $key, $list_item, $post_id, $get_option, $field_settings, $type );
            echo '</li>';
        ...
        echo '<div class="list-item-description">' . apply_filters( 'powen_list_item_description', $list_desc, $field_id ) . '</div>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_measurement' ) ) {
  
  function powen_type_measurement( $args = array() ) {
    ...
    echo '<div class="format-setting type-measurement ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        echo '<select name="' . esc_attr( $field_name ) . '[1]" id="' . esc_attr( $field_id ) . '-1" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
          ...
          foreach ( powen_measurement_unit_types( $field_id ) as $unit ) {
 ...
 * @since     2.1
 */
if ( ! function_exists( 'powen_type_numeric_slider' ) ) {

  function powen_type_numeric_slider( $args = array() ) {
    ...
    echo '<div class="format-setting type-numeric-slider ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        echo '<div class="ot-numeric-slider-wrap">';
          ...
          echo '<div id="powen_numeric_slider_' . esc_attr( $field_id ) . '" class="ot-numeric-slider"></div>';
 ...
 * @since     2.2.0
 */
if ( ! function_exists( 'powen_type_on_off' ) ) {

  function powen_type_on_off( $args = array() ) {
      ...
      echo '<div class="format-setting-inner">';
        ...
        $field_choices = array(
          array(
             ...
             */
            'value'   => apply_filters( 'powen_on_off_switch_on_value', 'on', $field_id, 'on' ),
            /**
             ...
             */
            'label'   => apply_filters( 'powen_on_off_switch_on_label', __( 'On', 'option-tree' ), $field_id, 'on' )
          ),
          array(
            /**
             ...
             * @param string $filter_id For filtering both on/off value with one function.
             */
            'value'   => apply_filters( 'powen_on_off_switch_off_value', 'off', $field_id, 'off' ),
            /**
             ...
             * @param string $filter_id For filtering both on/off label with one function.
             */
            'label'   => apply_filters( 'powen_on_off_switch_off_label', __( 'Off', 'option-tree' ), $field_id, 'off' )
          )
        );
         ...
         * @param string $field_id The field ID.
         */
        $switch_width = apply_filters( 'powen_on_off_switch_width', '100px', $field_id );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_page_checkbox' ) ) {
  
  function powen_type_page_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-page-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      /* query pages array */
      $my_posts = get_posts( apply_filters( 'powen_type_page_checkbox_query', array( 'post_type' => array( 'page' ), 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_page_select' ) ) {
  
  function powen_type_page_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-page-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query pages array */
        $my_posts = get_posts( apply_filters( 'powen_type_page_select_query', array( 'post_type' => array( 'page' ), 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_post_checkbox' ) ) {
  
  function powen_type_post_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-post-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query posts array */
        $my_posts = get_posts( apply_filters( 'powen_type_post_checkbox_query', array( 'post_type' => array( 'post' ), 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_post_select' ) ) {
  
  function powen_type_post_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-post-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query posts array */
        $my_posts = get_posts( apply_filters( 'powen_type_post_select_query', array( 'post_type' => array( 'post' ), 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_radio' ) ) {
  
  function powen_type_radio( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_radio_image' ) ) {
  
  function powen_type_radio_image( $args = array() ) {
    ...
    echo '<div class="format-setting type-radio-image ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( empty( $field_choices ) )
          $field_choices = powen_radio_images( $field_id );
          
        /* build radio image */
        foreach ( (array) $field_choices as $key => $choice ) {
          
          $src = str_replace( 'powen_URL', powen_URL, $choice['src'] );
          $src = str_replace( 'powen_THEME_URL', powen_THEME_URL, $src );
          
          /* make radio image source filterable */
          $src = apply_filters( 'powen_type_radio_image_src', $src, $field_id );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_select' ) ) {
  
  function powen_type_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      $field_choices = apply_filters( 'powen_type_select_choices', $field_choices, $field_id );
 ...
 * to use on a specific area. By using the two provided filters, 'powen_recognized_sidebars', 
 * and 'powen_recognized_sidebars_{$field_id}' we can be selective about which sidebars are 
 ...
 * @since     2.1
 */
if ( ! function_exists( 'powen_type_sidebar_select' ) ) {
  
  function powen_type_sidebar_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-sidebar-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        $sidebars = apply_filters( 'powen_recognized_sidebars', $sidebars );
        $sidebars = apply_filters( 'powen_recognized_sidebars_' . $field_id, $sidebars );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_slider' ) ) {
  
  function powen_type_slider( $args = array() ) {
 ...
 * @since     2.4.0
 */
if ( ! function_exists( 'powen_type_social_links' ) ) {
  
  function powen_type_social_links( $args = array() ) {
    
    /* turns arguments array into variables */
    extract( $args );
    
    /* Load the default social links */
    if ( empty( $field_value ) && apply_filters( 'powen_type_social_links_load_defaults', true, $field_id ) ) {
      
      $field_value = apply_filters( 'powen_type_social_links_defaults', array(
        array(
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $field_value ) && ! empty( $field_value ) ) {
          ...
          foreach( $field_value as $key => $link ) {
            ...
            echo '<li class="ui-state-default list-list-item">';
              powen_social_links_view( $field_id, $key, $link, $post_id, $get_option, $field_settings, $type );
            echo '</li>';
        ...
        /* description */
        echo '<div class="list-item-description">' . apply_filters( 'powen_social_links_description', __( 'You can re-order with drag & drop, the order will update after saving.', 'option-tree' ), $field_id ) . '</div>';
 ...
 * @since     2.5.0
 */
if ( ! function_exists( 'powen_type_spacing' ) ) {

  function powen_type_spacing( $args = array() ) {
    ...
    echo '<div class="format-setting type-spacing ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* allow fields to be filtered */
        $powen_recognized_spacing_fields = apply_filters( 'powen_recognized_spacing_fields', array(
          'top',
          'right',
          'bottom',
          'left',
        ...
        /* build top spacing */
        if ( in_array( 'top', $powen_recognized_spacing_fields ) ) {
        ...
        /* build right spacing */
        if ( in_array( 'right', $powen_recognized_spacing_fields ) ) {
        ...
        if ( in_array( 'bottom', $powen_recognized_spacing_fields ) ) {
        ...
        /* build left spacing */
        if ( in_array( 'left', $powen_recognized_spacing_fields ) ) {
      ...
      /* build unit dropdown */
      if ( in_array( 'unit', $powen_recognized_spacing_fields ) ) {
        ...
        echo '<div class="ot-option-group ot-option-group--is-last">';
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[unit]" id="' . esc_attr( $field_id ) . '-unit" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach ( powen_recognized_spacing_unit_types( $field_id ) as $unit ) {
              echo '<option value="' . esc_attr( $unit ) . '"' . ( isset( $field_value['unit'] ) ? selected( $field_value['unit'], $unit, false ) : '' ) . '>' . esc_attr( $unit ) . '</option>';
            }
 ...
 * @since     2.3.0
 */
if ( ! function_exists( 'powen_type_tab' ) ) {
  
  function powen_type_tab( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_tag_checkbox' ) ) {
  
  function powen_type_tag_checkbox( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_tag_select' ) ) {
  
  function powen_type_tag_select( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_taxonomy_checkbox' ) ) {
  
  function powen_type_taxonomy_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-taxonomy-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* get taxonomies */
        $taxonomies = get_categories( apply_filters( 'powen_type_taxonomy_checkbox_query', array( 'hide_empty' => false, 'taxonomy' => $taxonomy ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_taxonomy_select' ) ) {
  
  function powen_type_taxonomy_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-tag-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* get taxonomies */
        $taxonomies = get_categories( apply_filters( 'powen_type_taxonomy_select_query', array( 'hide_empty' => false, 'taxonomy' => $taxonomy ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_text' ) ) {
  
  function powen_type_text( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_textarea' ) ) {
  
  function powen_type_textarea( $args = array() ) {
      ...
      echo '<div class="format-setting-inner">';
        ...
        wp_editor( 
          ...
          array(
            ...
            'wpautop'       => apply_filters( 'powen_wpautop', false, $field_id ),
            'media_buttons' => apply_filters( 'powen_media_buttons', true, $field_id ),
            'textarea_name' => esc_attr( $field_name ),
            'textarea_rows' => esc_attr( $field_rows ),
            'tinymce'       => apply_filters( 'powen_tinymce', true, $field_id ),              
            'quicktags'     => apply_filters( 'powen_quicktags', array( 'buttons' => 'strong,em,link,block,del,ins,img,ul,ol,li,code,spell,close' ), $field_id )
          ) 
        );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_textarea_simple' ) ) {
  
  function powen_type_textarea_simple( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_textblock' ) ) {
  
  function powen_type_textblock( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_textblock_titled' ) ) {
  
  function powen_type_textblock_titled( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_typography' ) ) {
  
  function powen_type_typography( $args = array() ) {
    ...
    echo '<div class="format-setting type-typography ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">'; 
        ...
        /* allow fields to be filtered */
        $powen_recognized_typography_fields = apply_filters( 'powen_recognized_typography_fields', array( 
          'font-color',
          'font-family', 
          'font-size', 
          'font-style', 
        ...
        /* build font color */
        if ( in_array( 'font-color', $powen_recognized_typography_fields ) ) {
        ...
        /* build font family */
        if ( in_array( 'font-family', $powen_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[font-family]" id="' . esc_attr( $field_id ) . '-font-family" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach ( powen_recognized_font_families( $field_id ) as $key => $value ) {
        ...
        /* build font size */
        if ( in_array( 'font-size', $powen_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[font-size]" id="' . esc_attr( $field_id ) . '-font-size" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach( powen_recognized_font_sizes( $field_id ) as $option ) { 
        ...
        /* build font style */
        if ( in_array( 'font-style', $powen_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[font-style]" id="' . esc_attr( $field_id ) . '-font-style" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach ( powen_recognized_font_styles( $field_id ) as $key => $value ) {
        ...
        /* build font variant */
        if ( in_array( 'font-variant', $powen_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[font-variant]" id="' . esc_attr( $field_id ) . '-font-variant" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach ( powen_recognized_font_variants( $field_id ) as $key => $value ) {
        ...
        /* build font weight */
        if ( in_array( 'font-weight', $powen_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[font-weight]" id="' . esc_attr( $field_id ) . '-font-weight" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach ( powen_recognized_font_weights( $field_id ) as $key => $value ) {
        ...
        if ( in_array( 'letter-spacing', $powen_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[letter-spacing]" id="' . esc_attr( $field_id ) . '-letter-spacing" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach( powen_recognized_letter_spacing( $field_id ) as $option ) { 
        ...
        /* build line height */
        if ( in_array( 'line-height', $powen_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[line-height]" id="' . esc_attr( $field_id ) . '-line-height" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach( powen_recognized_line_heights( $field_id ) as $option ) { 
        ...
        if ( in_array( 'text-decoration', $powen_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[text-decoration]" id="' . esc_attr( $field_id ) . '-text-decoration" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach ( powen_recognized_text_decorations( $field_id ) as $key => $value ) {
        ...
        if ( in_array( 'text-transform', $powen_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[text-transform]" id="' . esc_attr( $field_id ) . '-text-transform" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach ( powen_recognized_text_transformations( $field_id ) as $key => $value ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_upload' ) ) {
  
  function powen_type_upload( $args = array() ) {
