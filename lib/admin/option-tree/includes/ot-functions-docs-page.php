 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_creating_options' ) ) {
  
  function powen_type_creating_options() {
    ...
    echo '<div class="format-setting type-textblock wide-desc">';
      ...
      echo '<div class="description">';
        ...
        foreach( powen_option_types_array() as $key => $value )
          echo '<li>' . $value . '</li>';
        echo '</ul>';
...
/**
 * powen_get_option() option type.
 *
 * This is a callback function to display text about powen_get_option().
 *
 * @return    string
 *
 * @access    public
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_option_types' ) ) {
  
  function powen_type_option_types() {
...
add_filter( \'powen_measurement_unit_types\', \'filter_measurement_unit_types\', 10, 2 );</code></pre>';
...
add_filter( \'powen_measurement_unit_types\', \'filter_measurement_unit_types\', 10, 2 );</code></pre>';
        ...
        echo '<p>' . sprintf( __( 'the Radio Images option type is primarily used for layouts. However, you can filter the image list using %s. As well, you can add your own custom images using the choices array.', 'option-tree' ), '<code>powen_radio_images</code>' ) . '</p>';
        
        echo '<p>' . __( 'This example executes the <code>powen_radio_images</code> filter on layout images attached to the <code>my_radio_images</code> field. Added to <code>functions.php</code>.', 'option-tree' ) . '</p>';
...
add_filter( \'powen_radio_images\', \'filter_radio_images\', 10, 2 );</code></pre>';
        ...
        echo '<p>' . sprintf(  __( 'This option type makes it possible for users to select a WordPress registered sidebar to use on a specific area. By using the two provided filters, %s, and %s we can be selective about which sidebars are available on a specific content area.', 'option-tree' ), '<code>powen_recognized_sidebars</code>', '<code>powen_recognized_sidebars_{$field_id}</code>' ) . '</p>';
...
add_filter( \'powen_wpautop\', \'filter_textarea_wpautop\', 10, 2 );</code></pre>';
...
add_filter( \'powen_media_buttons\', \'filter_textarea_media_buttons\', 10, 2 );</code></pre>';
...
add_filter( \'powen_tinymce\', \'filter_textarea_tinymce\', 10, 2 );</code></pre>';
...
add_filter( \'powen_quicktags\', \'filter_textarea_quicktags\', 10, 1 );</code></pre>';
...
add_filter( \'powen_wpautop\', \'filter_textarea_simple_wpautop\', 10, 2 );</code></pre>';
        ...
        echo '<p>' . sprintf( __( 'The Typography option type is for adding typography styles to your theme either dynamically via the CSS option type above or manually with %s. The Typography option type has filters that allow you to remove fields or change the defaults. For example, you can filter %s to remove unwanted fields from all Background options or an individual one. You can also filter %s. These filters allow you to fine tune the select lists for your specific needs.', 'option-tree' ), '<code>powen_get_option()</code>', '<code>powen_recognized_typography_fields</code>', '<code>powen_recognized_font_families</code>, <code>powen_recognized_font_sizes</code>, <code>powen_recognized_font_styles</code>, <code>powen_recognized_font_variants</code>, <code>powen_recognized_font_weights</code>, <code>powen_recognized_letter_spacing</code>, <code>powen_recognized_line_heights</code>, <code>powen_recognized_text_decorations</code> ' . __( 'and', 'option-tree' ) . ' <code>powen_recognized_text_transformations</code>' ) . '</p>';
        
        echo '<p class="aside">' . __( 'This example would filter <code>powen_recognized_font_families</code> to build your own font stack. Added to <code>functions.php</code>.', 'option-tree' ) . '</p>';
        echo '<pre><code>function filter_powen_recognized_font_families( $array, $field_id ) {
...
add_filter( \'powen_recognized_font_families\', \'filter_powen_recognized_font_families\', 10, 2 );</code></pre>';

        echo '<h4>'. __( 'Upload', 'option-tree' ) . ':</h4>'; 
        echo '<p>' . sprintf( __( 'The Upload option type is used to upload any WordPress supported media. After uploading, users are required to press the "%s" button in order to populate the input with the URI of that media. There is one caveat of this feature. If you import the theme options and have uploaded media on one site the old URI will not reflect the URI of your new site. You will have to re-upload or %s any media to your new server and change the URIs if necessary.', 'option-tree' ), apply_filters( 'powen_upload_text', __( 'Send to OptionTree', 'option-tree' ) ), 'FTP' ) . '</p>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_powen_get_option' ) ) {
  
  function powen_type_powen_get_option() {
    ...
    echo '<div class="format-setting type-textblock wide-desc">';
      ...
      echo '<div class="description">';
        ...
        echo '<p><code>&lt;?php powen_get_option( $option_id, $default ); ?&gt;</code></p>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_get_option_tree' ) ) {
  
  function powen_type_get_option_tree() {
    ...
    echo '<div class="format-setting type-textblock wide-desc">';
      ...
      echo '<div class="description">';
        ...
        echo '<p>' . __( 'Use', 'option-tree' ) . '<code>powen_get_option()</code>' . __( 'instead', 'option-tree' ) . '.</p>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_examples' ) ) {
  
  function powen_type_examples() {
  ...
  $ids = powen_get_option( \'navigation_ids\', array() );
  ...
  if ( ! empty( $ids ) )
    ...
    echo \'&lt;/ul&gt;\';
        ...
        echo '<pre><code>if ( function_exists( \'powen_get_option\' ) ) {
  /* get the array */
  $measurement = powen_get_option( \'measurement_option_type_id\' );
  ...
  $measurement = powen_get_option( \'measurement_option_type_id\', array( \'10\', \'px\' ) );
  ...
  $slides = powen_get_option( \'my_slider\', array() );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_layouts_overview' ) ) {
  
  function powen_type_layouts_overview() {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_meta_boxes' ) ) {
  
  function powen_type_meta_boxes() {
...
require( trailingslashit( get_template_directory() ) . \'includes/meta-boxes.php\' );
        ...
        echo '<ul class="docs-ul">';
          echo '<li>' . __( 'Add a variation of the following code to your <code>meta-boxes.php</code>. You\'ll obviously need to fill it in with all your custom array values. It\'s important to note here that we use the <code>admin_init</code> filter because if you were to call the <code>powen_register_meta_box</code> function before OptionTree was loaded the sky would fall on your head.', 'option-tree' ) . '</li>';
        echo '</ul>';
...
function custom_meta_boxes() {
  ...
  powen_register_meta_box( &#36;my_meta_box );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_theme_mode' ) ) {
  
  function powen_type_theme_mode() {
