...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'settings'        => array( 
      array(
        ...
        'desc'        => sprintf( __( 'The Background option type is for adding background styles to your theme either dynamically via the CSS option type below or manually with %s. The Background option type has filters that allow you to remove fields or change the defaults. For example, you can filter %s to remove unwanted fields from all Background options or an individual one. You can also filter %s. These filters allow you to fine tune the select lists for your specific needs.', 'theme-text-domain' ), '<code>powen_get_option()</code>', '<code>powen_recognized_background_fields</code>', '<code>powen_recognized_background_repeat</code>, <code>powen_recognized_background_attachment</code>, <code>powen_recognized_background_position</code>, ' . __( 'and', 'theme-text-domain' ) . ' <code>powen_type_background_size_choices</code>' ),
        'std'         => '',
        'type'        => 'background',
  ...
  {{demo_background}}
      ...
      array(
        ...
        'desc'        => sprintf( __( 'the Radio Images option type is primarily used for layouts. However, you can filter the image list using %s. As well, you can add your own custom images using the choices array.', 'theme-text-domain' ), '<code>powen_radio_images</code>' ),
        'std'         => 'right-sidebar',
        'type'        => 'radio-image',
        'section'     => 'option_types',
        'rows'        => '',
