...
function powen_favicon() { ?>
	...
	<link rel="shortcut icon" type="image" href="<?php echo get_theme_mod('powen_theme_favicon'); ?>">
...
//THEME FONT
function powen_powen_theme_font() { ?>

<style>
	body {
		font-family: <?php echo get_theme_mod( 'powen_theme_font', 'Courier New, Courier' ); ?>
	}
</style>

<?php }

add_action( 'wp_head', 'powen_powen_theme_font' );


//LOGO
function powen_logo() {
	$powen_logo_position = get_theme_mod( 'powen_logo_placement' );
...
function powen_title_layout() {
    $powen_header_text_position = get_theme_mod( 'header_text_placement' );
