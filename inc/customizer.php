<?php
  ...
  public static function register ( $wp_customize ) {
      ...
      //header text color
      $wp_customize->add_setting('powen_cus[header_textcolor]' , array(
          'default'           => '#000000',
          'transport'         => 'refresh',
      ...
      $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'powen_cus[header_textcolor]', array(
          'label'         => __( 'Header Title Color', 'powen' ),
          'section'       => 'colors',
          'settings'      => 'powen_cus[header_textcolor]',
      ) ) );

      //Header Tagline Color

      $wp_customize->add_setting( 'powen_cus[header_taglinecolor]', array(
          'default'           => '#222222',
          'transport'         => 'refresh',
          'sanitize_callback' => 'sanitize_hex_color',
          'capability'        => 'edit_theme_options',
      ...
      $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'powen_cus[header_taglinecolor]', array(
          'label'         => __( 'Header Tagline Color', 'powen' ),
          'section'       => 'colors',
          'settings'      => 'powen_cus[header_taglinecolor]',
      ) ) );

      //Header Background Color

      $wp_customize->add_setting( 'powen_cus[header_background]' , array(
          'default'           => '#ffffff',
          'transport'         => 'refresh',
          'sanitize_callback' => 'sanitize_hex_color',
          'capability'        => 'edit_theme_options',
      ...
      $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'powen_cus[header_background]', array(
        'label'           => __( 'Header Background Color', 'powen' ),
        'section'         => 'colors',
        'settings'        => 'powen_cus[header_background]',
      ) ) );
      ...
      $wp_customize->add_setting( 'powen_cus[footer_widgets_background]' , array(
          'default'           => '#222222',
          'transport'         => 'refresh',
          'sanitize_callback' => 'esc_url_raw',
          'capability'        => 'edit_theme_options',
      ...
      $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'powen_cus[footer_widgets_background]', array(
        'label'           => __( 'Footer widgets background color', 'powen' ),
        'section'         => 'powen_footer_background_section',
        'settings'        => 'powen_cus[footer_widgets_background]',
      ) ) );

      //Footer widgets text color

      $wp_customize->add_setting( 'powen_cus[footer_widgets_textcolor]', array(
        'default'           => '#808080',
        'transport'         => 'refresh',
        'sanitize_callback' => 'sanitize_hex_color',
        'capability'        => 'edit_theme_options',
      ...
      $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'powen_cus[footer_widgets_textcolor]', array(
        'label'           => __( 'Footer widgets text color', 'powen' ),
        'section'         => 'powen_footer_background_section',
        'settings'        => 'powen_cus[footer_widgets_textcolor]',
      ) ) );

      //Footer widgets link color

      $wp_customize->add_setting( 'powen_cus[footer_widgets_linkcolor]', array(
        'default'           => '#cccccc',
        'transport'         => 'refresh',
        'sanitize_callback' => 'esc_url_raw',
        'capability'        => 'edit_theme_options',
      ...
      $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'powen_cus[footer_widgets_linkcolor]', array(
        'label'           => __( 'Footer widgets link color', 'powen' ),
        'section'         => 'powen_footer_background_section',
        'settings'        => 'powen_cus[footer_widgets_linkcolor]',
      ) ) );

      //Footer bottom background color

      $wp_customize->add_setting( 'powen_cus[footer_bottom_background_color]' , array(
          'default'           => '#000000',
          'transport'         => 'refresh',
          'sanitize_callback' => 'sanitize_hex_color',
          'capability'        => 'edit_theme_options',
      ...
      $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'powen_cus[footer_bottom_background_color]', array(
          'label'    => __( 'Footer bottom background color', 'powen' ),
          'section'  => 'powen_footer_background_section',
          'settings' => 'powen_cus[footer_bottom_background_color]',
      ) ) );

      //Footer bottom text color

      $wp_customize->add_setting( 'powen_cus[footer_bottom_textcolor]' , array(
          'default'       => '#999999',
          'transport'     => 'refresh',
          'sanitize_callback' => 'sanitize_hex_color',
          'capability'  => 'edit_theme_options',
      ...
      $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'powen_cus[footer_bottom_textcolor]', array(
          'label'    => __( 'Footer bottom text color', 'powen' ),
          'section'  => 'powen_footer_background_section',
          'settings' => 'powen_cus[footer_bottom_textcolor]',
      ) ) );
      ...
      $wp_customize->add_control( 'powen_cus[logo_placement]', array(
          ...
          'section'       => 'powen_logo_section',
          'setting'       => 'powen_cus[logo_placement]',
          'choices'       => array(
              'left'      => 'Left',
              'right'     => 'Right',
              'center'    => 'Center',
  ...
  public static function background() {
    ...
    <style type="text/css">
        ...
        <?php self::generate_css('.site-description', 'color', 'header_taglinecolor'); ?>
        <?php self::generate_css('body', 'background-color', 'background_color', '#'); ?>
        <?php self::generate_css('.site-header', 'background-color', 'header_background'); ?>
        <?php self::generate_css('.footer_widgets', 'background-color', 'footer_widgets_background'); ?>
        <?php self::generate_css('.footer_widgets', 'color', 'footer_widgets_textcolor'); ?>
        <?php self::generate_css('.footer_widgets a', 'color', 'footer_widgets_linkcolor'); ?>
        <?php self::generate_css('.site-info a', 'color', 'footer_bottom_textcolor'); ?>
        <?php self::generate_css('.site-info', 'color', 'footer_bottom_textcolor'); ?>
        <?php self::generate_css('.site-info', 'background-color', 'footer_bottom_background_color'); ?>
    </style>
    <!--/Customizer CSS-->
    <?php
  }
