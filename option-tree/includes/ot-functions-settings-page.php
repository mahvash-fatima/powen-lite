 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_theme_options_ui' ) ) {
  
  function powen_type_theme_options_ui() {
    global $blog_id;
    ...
    echo '<form method="post" id="option-tree-settings-form">';
      ...
      echo '<div class="format-setting type-textblock has-desc">';
        ...
        echo '<div class="description">';
          ...
          echo '<p class="warning">' . sprintf( __( 'Go to the %s page if you want to save data, this page is for adding settings.', 'option-tree' ), '<a href="' . get_admin_url( $blog_id, apply_filters( 'powen_theme_options_parent_slug', 'themes.php' ) . '?page=' . apply_filters( 'powen_theme_options_menu_slug', 'powen-theme-options' ) ) . '"><code>Appearance->Theme Options</code></a>' ) . '</p>';
        ...
        echo '<div class="format-setting-inner">';
          ...
          echo '<ul class="option-tree-setting-wrap option-tree-sortable" id="option_tree_settings_list" data-name="' . powen_settings_id() . '[settings]">';
          ...
          if ( isset( $settings['sections'] ) ) {
            ...
            foreach( $settings['sections'] as $section ) {
              ...
              /* section */
              echo '<li class="' . ( $count == 0 ? 'ui-state-disabled' : 'ui-state-default' ) . ' list-section">' . powen_sections_view( powen_settings_id() . '[sections]', $count, $section ) . '</li>';
              ...
              if ( isset( $settings['settings'] ) ) {
                ...
                foreach( $settings['settings'] as $setting ) {
                  ...
                  if ( isset( $setting['section'] ) && $setting['section'] == $section['id'] ) {
                    ...
                    echo '<li class="ui-state-default list-setting">' . powen_settings_view( powen_settings_id() . '[settings]', $count, $setting ) . '</li>';
          ...
          <div class="format-settings" id="contextual-help-setting">
            <div class="format-setting type-textarea no-desc">
              ...
              <div class="format-setting-inner">
                <textarea class="textarea" rows="10" cols="40" name="' . powen_settings_id(). '[contextual_help][sidebar]">' . ( isset( $settings['contextual_help']['sidebar'] ) ? esc_html( $settings['contextual_help']['sidebar'] ) : '' ) . '</textarea>
              </div>
            </div>
          </div>';
          ...
          echo '<ul class="option-tree-setting-wrap option-tree-sortable" id="option_tree_settings_help" data-name="' . powen_settings_id(). '[contextual_help][content]">';
          ...
          if ( isset( $settings['contextual_help']['content'] ) ) {
            ...
            foreach( $settings['contextual_help']['content'] as $content ) {
              ...
              /* content */
              echo '<li class="ui-state-default list-contextual-help">' . powen_contextual_help_view( powen_settings_id() . '[contextual_help][content]',  $count, $content ) . '</li>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_import_xml' ) ) {
  
  function powen_type_import_xml() {
      ...
      echo '<div class="format-setting type-textblock has-desc">';
        ...
        echo '<div class="format-setting-inner">';
          ...
          echo '<div class="option-tree-ui-upload-parent">';
            ...
            /* get media post_id */
            $post_id = ( $id = powen_get_media_post_ID() ) ? (int) $id : 0;
          
            /* add xml button */
            echo '<a href="javascript:void(0);" class="powen_upload_media option-tree-ui-button button button-primary light" rel="' . $post_id . '" title="' . __( 'Add XML', 'option-tree' ) . '"><span class="icon ot-icon-plus-circle"></span>' . __( 'Add XML', 'option-tree' ) . '</a>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_import_settings' ) ) {
  
  function powen_type_import_settings() {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_import_data' ) ) {
  
  function powen_type_import_data() {
    ...
    echo '<form method="post" id="import-data-form">';
      ...
      echo '<div class="format-setting type-textarea has-desc">';
        ...
        echo '<div class="description">';
          ...
          if ( powen_SHOW_SETTINGS_IMPORT ) echo '<p>' . __( 'Only after you\'ve imported the Settings should you try and update your Theme Options.', 'option-tree' ) . '</p>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_import_layouts' ) ) {
  
  function powen_type_import_layouts() {
    ...
    echo '<form method="post" id="import-layouts-form">';
      ...
      echo '<div class="format-setting type-textarea has-desc">';
        ...
        echo '<div class="description">';
          ...
          if ( powen_SHOW_SETTINGS_IMPORT ) echo '<p>' . __( 'Only after you\'ve imported the Settings should you try and update your Layouts.', 'option-tree' ) . '</p>';
 ...
 * @since     2.0.8
 */
if ( ! function_exists( 'powen_type_export_settings_file' ) ) {
  
  function powen_type_export_settings_file() {
    global $blog_id;
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_export_settings' ) ) {
  
  function powen_type_export_settings() {
    ...
    echo '<div class="format-setting type-textarea simple has-desc">';
      ...
      $settings = get_option( powen_settings_id() );
      $settings = ! empty( $settings ) ?  powen_encode( serialize( $settings ) ) : '';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_export_data' ) ) {
  
  function powen_type_export_data() {
    ...
    echo '<div class="format-setting type-textarea simple has-desc">';
      ...
      /* get theme options data */
      $data = get_option( powen_options_id() );
      $data = ! empty( $data ) ? powen_encode( serialize( $data ) ) : '';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_export_layouts' ) ) {
  
  function powen_type_export_layouts() {
    ...
    echo '<div class="format-setting type-textarea simple has-desc">';
      ...
      $layouts = ! empty( $layouts ) ? powen_encode( serialize( $layouts ) ) : '';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'powen_type_modify_layouts' ) ) {
  
  function powen_type_modify_layouts() {
    ...
    echo '<form method="post" id="option-tree-settings-form">';
      ...
      echo '<div class="format-setting type-textarea has-desc">';
        ...
        echo '<div class="description">';
          ...
          if ( powen_SHOW_DOCS ) echo '<p>' . __( 'Visit <code>OptionTree->Documentation->Layouts Overview</code> to see a more in-depth description of what layouts are and how to use them.', 'option-tree' ) . '</p>';
        ...
        echo '<div class="format-setting-inner">';
          ...
          echo '<input type="hidden" name="' . powen_layouts_id() . '[active_layout]" value="' . esc_attr( $active_layout ) . '" class="active-layout-input" />';
          ...
          if ( is_array( $layouts ) && ! empty( $layouts ) ) {
            ...
            foreach( $layouts as $key => $data ) {
              ...
              /* content */
              echo '<li class="ui-state-default list-layouts">' . powen_layout_view( $key, $data, $active_layout ) . '</li>';
